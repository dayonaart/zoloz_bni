...
class _MyAppState extends State<MyApp> {
  ...
  final _baseUrl = "https://sg-production-cdn.zoloz.com/page/zoloz-realid-fe";
  String get _zolozUrl =>
      "$_baseUrl?clientcfg=${Uri.encodeComponent(_clientCfg)}";
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: SafeArea(child: WEB_BROWSER(url: _zolozUrl)),
    );
  }
...
Widget WEB_BROWSER({String? url}) {
  print(url);
  return ChromeBrowser(url);
}
